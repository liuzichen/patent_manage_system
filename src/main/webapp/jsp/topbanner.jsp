...
<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0"
	...
	<div id="mainbanner">
		...
		<ul id="navmenu">
			...
			<li><img alt="" src="/image/03.jpg"
				style="float: left; margin-left: 20px; margin-top: -1px"
				height="20px" width="20px"><a
				href="<%=request.getContextPath()%>/jsp/repassword.jsp"
				id="editpass" target="PageFrame">修改密码</a></li>
			<li><img alt="" src="/image/01.jpg"
				style="float: left; margin-left: 35px; margin-top: -1px"
				height="20px" width="20px"><a
				href="<%=request.getContextPath()%>/login/<%=session.getAttribute("type") %>"
