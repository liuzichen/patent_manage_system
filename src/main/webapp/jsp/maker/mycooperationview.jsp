...
<body>
	<div>
		...
		<div class="context">
			<div class="titlebox">
				<span class="title">合作意向详情</span>
			</div>
			<div>
				<form
					action="<%=request.getContextPath()%>/maker/updateMyCooperation"
					name="Form1" id="Form1">
							...
							<td align="center" height="400px" colspan="3">
								<div class="tdcontent3">
									<textarea id="description" name="description" cols="40"
										rows="12" style="width: 90%; height: 100%;">${detail.detail }</textarea>
								</div>
						</tr>
						<tr>
							<td align="center" colspan="4">
								<div
									...
									<a href="javascript:void(document.Form1.submit())"
										...
										class="easyui-linkbutton button" onclick="return sub();">提&nbsp;交&nbsp;更&nbsp;改</a>
								</div>
							</td>
						</tr>
					</table>
