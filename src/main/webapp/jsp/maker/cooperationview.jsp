							...
							<td colspan="3">
								<div class="tdcontent3">
									<div
										...
										<pre
											style="width: 100%; white-space: pre-wrap; font-size: 16px">${detail.teamIntro }</pre>
									</div>
								</div>
						</tr>
						<tr>
							...
							<td colspan="3">
								<div class="tdcontent3">
									<div
										style="word-wrap: break-word; word-break: break-all; margin: 0 auto; width: 95%;">
										<pre
											style="width: 100%; white-space: pre-wrap; font-size: 16px">${detail.detail }</pre>
									</div>
								</div>
						</tr>
