					...
					<td style="vertical-align: top">
							...
							<tr>
								<td width="45%" style="padding-right: 5px; vertical-align: top">
									...
									<div class="maintitlebg">
										<span><a
											href="<%=request.getContextPath()%>/jsp/maker/mprojectoverview.jsp">更多>></a></span>
										<div></div>
									...
									<div class="titlebox">
										<ul>
											<c:forEach items="${project}" var="item">
												...
												<li><span>${item.startTime}</span><a
													href="<%=request.getContextPath()%>/maker/makerProjectDetail?projectId=${item.id}"><span
									...
									<div class="maintitlebg" style="margin-top: 18px;">
										<span><a
											href="<%=request.getContextPath()%>/maker/loginNewsList?type=4">更多>></a></span>
								...
								<td width="45%" valign="top" style="padding-left: 5px;">
									...
									<div class="maintitlebg">
										<span><a
											href="<%=request.getContextPath()%>/maker/loginNewsList?type=2">更多>></a></span>
									...
									<div class="maintitlebg" style="margin-top: 18px;">
										<span><a
											href="<%=request.getContextPath()%>/maker/loginNewsList?type=3">更多>></a></span>
						...
						<div class="srortcut4box" style="margin-top: 10px;">
							<ul>
								...
								<li><a
									href="<%=request.getContextPath()%>/jsp/maker/mworkoverview.jsp">
										<img src="<%=request.getContextPath()%>/image/22.jpg"
										style="position: relative; float: left; margin-left: 35px; margin-bottom: auto; margin-top: -15px"
										height="50px" width="50px">我的成果
								</a></li>
								<li><a
									href="<%=request.getContextPath()%>/jsp/maker/mycooperationoverview.jsp">
										<img src="<%=request.getContextPath()%>/image/23.jpg"
										style="position: relative; float: left; margin-left: 35px; margin-bottom: auto; margin-top: -15px"
										height="50px" width="50px">我的合作
								</a></li>
							</ul>
							<div class="clear"></div>
						</div> <!--快捷菜单 End-->
