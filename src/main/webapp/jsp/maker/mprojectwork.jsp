...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/js/jquery-easyui-1.4.4/demo.css">
<link rel="stylesheet" type="text/css"
...
<body>
	<div>
		...
		<div class="context">
			<div class="titlebox">
				<span class="title">项目作品提交</span>
			</div>
			<div>
				<form
					action="<%=request.getContextPath()%>/maker/insertMakerProjectWork"
					name="Form1" id="Form1">
					...
					<table class="persional" align="center" border="1" cellpadding="0"
						...
						<tr>
							...
							<td class="tdcontent2"><input
								class="easyui-textbox mydatebox" type="text" name="project"
								id="project" readonly="true" value=${project.title }></td>
						</tr>
						<tr>
							<td class="tdname">团队名称：</td>
							<td class="tdcontent1"><input
								class="easyui-textbox mydatebox" type="text" name="team"
								id="team" value=${makerInfo.team }></td>
