...
$(function () {
            ...
            $('#roleList').datagrid({
				...
				{field : 'sort',title : '类型',width : 160,align:'center',sortable:true}, 	
...
<body>
 ...
 <div>
    ...
    <div class="context" style="width:860px;">
     <div class="titlebox" style="width:100%; margin:0 auto;"><span class="title" >信息总览</span></div>
       	<!-- 显示总览 -->
