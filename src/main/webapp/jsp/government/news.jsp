...
<div >
	<div class="topnav"  >
	   <div  class="path" >
	      ...
	      <span ><font >信息与公告&nbsp;&nbsp; &gt;&nbsp;&nbsp; 政策资讯与通知公告</font></span>
	   </div>
     </div>
      <div class="context">
         <div class="titlebox"><span class="title">信息发布</span></div>
	     <div >
	     	 ...
	     	 <table class="persional" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA">
	     	 	<tr>
	     	 		...
	     	 		<td class="tdcontent2"><select id="type"  name="type" style="width:80%">
	     	 	...
	     	 	<td class="tdname">发布日期：</td>
                    <td class="tdcontent1">
                      <input class="easyui-datebox mydatebox" type="text" name="time" id="time" editable="false" panelHeight="260" panelWidth="200" >
                    </td>
