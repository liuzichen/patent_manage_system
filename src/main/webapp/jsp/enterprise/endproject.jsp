       ...
       <div title="报告扉页" style="width:100%">
	   	...
	   	<table class="persional" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA">
                <tr >
                    ...
                    <td class="tdcontent1"><input class="easyui-textbox mydatebox" type="text" name="G1" id="G1" >
                                        </td>
                    <td class="tdname">承担单位：</td>
                    <td class="tdcontent2">
					<input class="easyui-textbox mydatebox" type="text" name="G2" id="G2" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname">项目编号：</td>
                    <td class="tdcontent1">
                   <input class="easyui-textbox mydatebox" type="text" name="G3" id="G3" >
                    </td>
                    <td class="tdname">技术领域：</td>
                    <td class="tdcontent2">
                       <input class="easyui-textbox mydatebox" type="text" name="G4" id="G4" >
                    </td>                    
                </tr>
                <tr>
                    <td class="tdname">归口管理部门：</td>
                    <td class="tdcontent1">
                      <input class="easyui-textbox mydatebox" type="text" name="G5" id="G5" >
                    </td>
                    <td class="tdname">起止日期：</td>
                    <td class="tdcontent2">
                      <input class="easyui-datebox mydatebox" type="text" name="G6" id="G6" editable="false" panelHeight="260" panelWidth="200" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname">联系人：</td>
                    <td class="tdcontent1">
                   <input class="easyui-textbox mydatebox" type="text" name="G7" id="G7" >
                    </td>
                    <td class="tdname">电话：</td>
                    <td class="tdcontent2">
                       <input class="easyui-textbox mydatebox" type="text" name="G8" id="G8" >
                    </td>                    
                </tr>
                <tr>
       ...
       <div title="项目验收信息表" style="width:100%">
	   	...
	   	<table class="persional" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA">
                ...
                <tr >
                    ...
                    <td class="tdcontent1">
                       <input class="easyui-textbox mydatebox" type="text" name="K3" id="K3" >
                    </td>
                    <td class="tdname">项目编号：</td>
                    <td class="tdcontent2">
                       <input class="easyui-textbox mydatebox" type="text" name="K4" id="K4" >
                    </td>                    
                </tr>
                </table>
                <table class="persional" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA" >
                <tr>
	   			...
	   			<td colspan="2" class="tdtitle" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;二、项目进展情况</td>
                    ...
                    <td class="tdcontent2" >
                      <input class="easyui-textbox mydatebox" type="text" name="K5" id="K5" >
                    </td>
                ...
                <tr>
                	...
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K6" id="K6" ></td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K7" id="K7" ></td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K8" id="K8" ></td>
                <tr>
                <tr>
                	<td style="height:35px;text-align:center;background-color:#F2F2F2;">市财政拨款：</td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K9" id="K9" ></td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K10" id="K10" ></td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K11" id="K11" ></td>
                <tr>
                <tr>
                	<td style="height:35px;text-align:center;background-color:#F2F2F2;">国家、省财政拨款：</td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K12" id="K12" ></td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K13" id="K13" ></td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K14" id="K14" >></td>
                <tr>
                <tr>
                	<td style="height:35px;text-align:center;background-color:#F2F2F2;">其他：</td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K15" id="K15" ></td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K16" id="K16" ></td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K17" id="K17" ></td>
                <tr>
                <tr>
                	<td style="height:35px;text-align:center;background-color:#F2F2F2;">合计：</td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K18" id="K18" ></td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K19" id="K19" ></td>
                	<td style="text-align:center;"><input class="easyui-textbox mydatebox" type="text" name="K20" id="K20" ></td>
                <tr>
             </table>
              <table class="persional" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA">
              	<tr>
                ...
                <tr >
                    ...
                    <td class="tdcontent1" colspan="3">
                      <input class="easyui-textbox mydatebox" type="text" name="K29" id="2K9" >项
                    </td>                
                </tr>
                <tr >
	   ...
	   <div style="width:100%">
	   	...
	   	<table class="persional" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA">
                <tr >
                    <td class="tdname">项目名称：</td>                    
                    <td class="tdcontent1" colspan="2">
                      <input class="easyui-textbox mydatebox" type="text" name="I1" id="I1" >
                    </td>
                    <td class="tdname">承担单位：</td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I2" id="I2" >
                    </td>
                </tr>
                <tr >
                ...
                <tr >
                    ...
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I3" id="I3" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I4" id="I4" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">市科技计划拨款</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I5" id="I5" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I6" id="I6" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">单位自筹</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I7" id="I7" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I8" id="I8" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">自筹</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I9" id="I9" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I10" id="I10" >
                    </td>
                </tr>    
                <tr >
                ...
                <tr >
                    <td class="tdname" colspan="2">合计</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I11" id="I11" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I12" id="I12" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">1．设备费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I13" id="I13" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I14" id="I14" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">（1）购置设备费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I15" id="I15" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I16" id="I16" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">（2）试制设备费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I17" id="I17" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I18" id="I18" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">（3）设备改造与租赁费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I19" id="I19" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I20" id="I20" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">2.材料费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I21" id="I21" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I22" id="I22" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">3.测试化验加工费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I23" id="I23" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I24" id="I24" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">4.燃料动力费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I25" id="I25" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I26" id="I26" >
                    </td>
                </tr>
                ...
                <tr >
                    ...
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I27" id="I27" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I28" id="I28" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">6．会议费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I29" id="I29" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I30" id="I30" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">7．国际合作与交流费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I31" id="I31" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I32" id="I32" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">8．出版/文献/信息传播/知识产权事务费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I33" id="I33" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I34" id="I34" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">9．劳务费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I35" id="I35" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I36" id="I36" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">10．专家咨询费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I37" id="I37" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I38" id="I38" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">11．管理费</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I39" id="I39" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I40" id="I40" >
                    </td>
                </tr>
                <tr >
                    <td class="tdname" colspan="2">12．其他</td>                                    
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I41" id="I41" >
                    </td>
                    <td class="tdcontent2" colspan="2">
                    	<input class="easyui-textbox mydatebox" type="text" name="I42" id="I42" >
                    </td>
                </tr>
             <tr>
