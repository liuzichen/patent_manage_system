				...
				{field : 'YEAR',title : '计划年度',width : 160,align:'center',sortable:true},
				 ...
				 { field: 'opt', title: '详情了解', width: 160, align: 'center',
                    formatter: function (value,row,index) {
                    	return "<a href='<%=request.getContextPath()%>/jsp/enterprise/proordview.jsp' >查看详情</a>";  
                    }
                }
...
<body>
 ...
 <div>
    ...
    <div class="context" style="width:900px;">
     <div class="titlebox" style="width:100%; margin:0 auto;"><span class="title" >企业一般项目总览</span></div>
