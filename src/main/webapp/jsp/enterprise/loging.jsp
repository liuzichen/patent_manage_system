                   ...
                   <!--快捷菜单 Begin-->
                    <div class="srortcut4box" style="margin-top: 10px;">
                        <ul>
                            ...
                            <li><a href="#">
                                <img src="<%=request.getContextPath()%>/image/22.jpg" style="position:relative;float:left; margin-left:35px; margin-bottom:auto; margin-top:-15px" height="50px" width="50px" >我的项目</a></li>
                                <li><a href="#">
