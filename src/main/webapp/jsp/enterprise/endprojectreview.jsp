	   	...
	   	<table class="persional" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA">
             ...
             <tr>
	             <td align="center" colspan="6">	             	
		            <div style="margin-top:20px; margin-bottom:20px;float:right; position:relative; right:20px"><a href="<%=request.getContextPath() %>/*******.do" style="height:35px;width:100px;font-size:16px" class="easyui-linkbutton button" onclick="">下载附件</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
