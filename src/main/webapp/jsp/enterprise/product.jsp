...
<div >
	<div class="topnav"  >
	   <div  class="path" >
	      ...
	      <span ><font >科技项目管理&nbsp;&nbsp; &gt;&nbsp;&nbsp; 成果管理</font></span>
	   </div>
     </div>
      <div class="context">
         <div class="titlebox"><span class="title">科技项目成果提交</span></div>
	     <div >
	     	 ...
	     	 <table class="persional" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA">
	     	 	<tr>
	     	 		...
	     	 		<td class="tdcontent1" colspan="3"><input class="easyui-textbox mydatebox" type="text" name="title" id="title" style="width:90%"></td>	     	 		
	     	 	</tr>
	     	 	<tr>
	     	 	...
	     	 	<tr>
	     	 		<td class="tdname">证书号<font style="color:red;margin-left:0px;">(非论文类成果)：</font></td>
	     	 		<td class="tdcontent1"><input class="easyui-textbox mydatebox" type="text" name="code" id="code" ></td>
