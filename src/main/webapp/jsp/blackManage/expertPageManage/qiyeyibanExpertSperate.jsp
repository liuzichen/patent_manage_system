...
<body>
	<div>
		<div class="topnav">
			<div class="path">
				<span><font>当前位置:</font></span> <span><font>企业一般项目专家分配&nbsp;&nbsp;
						&gt;&nbsp;&nbsp;分配专家</font></span>
			</div>
		</div>
		<div class="context">
			...
			<div>
				<form
					action="<%=request.getContextPath()%>/manageEnterprise/AssignExpertForEnterCommonWork"
					name="Form1" id="Form1">
					<input type="hidden" id="projectid" name="projectid"
						value=${detail.id}> <input type="hidden" id="commentType"
						name="commentType" value="comment_entercommonproject"> <input
