...
$(function () {
            ...
            $('#roleList').datagrid({
				...
				{field : 'submitTime',title : '时间',width : 208,align:'center'},

            	{field: 'opt2', title: '分配专家', width: 160, align: 'center',
                    formatter: function (value,row,index) {
                    	return "<a href='<%=request.getContextPath()%>/manageEnterprise/toAssignExpertForEnterCommonWork?id="+ row.id +"'>分配专家</a>";  
                    }
                }
...
function sear(){
	...
	var state="";
    $.ajax({
        url:'<%=request.getContextPath()%>/manageEnterprise/manageEnterpriseNAList',
		...
		<div class="topnav">
			<div class="path">
				<span><font>当前位置:</font></span> <span><font>专家分配管理&nbsp;&nbsp;
						&gt;&nbsp;&nbsp;企业一般待评审专家分配总览</font></span>
			</div>
		</div>
		<form action="#" name="Form1" id="Form1">
			<input type="hidden" id="id" name="id">
			<div class="context" style="width: 925px">
				<div class="titlebox" style="width: 100%; margin: 0 auto;">
					<span class="title">企业一般待评审专家分配列表</span>
				</div>
