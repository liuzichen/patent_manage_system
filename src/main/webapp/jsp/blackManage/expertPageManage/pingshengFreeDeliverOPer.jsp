...
<body>
	<div>
		<div class="topnav">
			<div class="path">
				<span><font>当前位置:</font></span> <span><font>企业科技项目待专家分配&nbsp;&nbsp;
						&gt;&nbsp;&nbsp;分配专家</font></span>
			</div>
			<div class="context">
				<div class="titlebox">
					...
					<form action="###" name="Form1" id="Form1">
						...
						<table class="persional" align="center" border="1" cellpadding="0"
							...
							<tr>
								...
								<td class="tdcontent2"><%=request.getAttribute("Name")%></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="tdcontent2"><%=request.getAttribute("Time")%></td>
							</tr>
							<tr>
								<td class="tdname">请选择评审费发放金额:</td>
								<td class="tdcontent2"><select id="Fee" name="Fee"
									class="mydatebox">
