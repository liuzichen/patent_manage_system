...
$(function () {
            ...
            $('#roleList').datagrid({
				...
				{field : 'TITLE', title : '企业科技项目名称',width :330,align:'center'},
				{field : 'CONTRACTOR',title : '承建单位',width : 214,align:'center'},
            	...
            	{field: 'opt2', title: '分配专家', width: 160, align: 'center',
                    formatter: function (value,row,index) {
                    	return "<a href='#' onclick='return sub("+index+")'>分配专家</a>";  
                    }
                }
 ...
 <div>
     ...
     <div class="topnav"  >
	   <div  class="path" >
	      ...
	      <span ><font >专家分配管理&nbsp;&nbsp; &gt;&nbsp;&nbsp;企业科技项目待专家分配一览表</font></span>
	   </div>
     </div> 
	<form action="#" name="Form1" id="Form1">
       	<input type="hidden" id="id" name="id">	 
    <div class="context" style="width:1085px">
     <div class="titlebox" style="width:100%; margin:0 auto;"><span class="title" >企业科技项目待专家分配一览表</span></div>
