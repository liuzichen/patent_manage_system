...
.xline {
	border-bottom: solid 2px #7A378B;
	height: 5px;
	width: 1000px;
	margin: 0px auto;
}
...
<body>
	...
	<div class="header">
		<div class="header_left">
			<img src="<%=request.getContextPath()%>/image/login_logo.jpg"
				style="width: 100%; height: 100%"></img>
		</div>
	</div>
	<div class="title">
		<div class="title_left">
			<span style="position: absolute; bottom: 0px;">企业用户注册</span> <span
				style="position: absolute; bottom: 0px; font-size: 12px; left: 180px">适用于:大、中型企业</span>
		</div>
		<div class="title_right">
			<a
				href="<%=request.getContextPath()%>/jsp/blackManage/test/register_maker.jsp"
				style="position: absolute; bottom: 0px;">切换到创客用户注册</a>
			<!-- 提取创客注册相关信息后台代码 -->
		</div>
	</div>
	<div class="xline"></div>
	<div class="info">
		<form method="post" action="" id="register_Form" name="register_Form">
			...
			<div class="info_form1">
				<input type="hidden" name="register_roleid" id="register_roleid"
					value="3">
				<table border="0" cellspacing="0" cellpadding="0"
					style="margin: 0px auto;">
					<tr>
						<td width="60">用&nbsp;户&nbsp;名:</td>
						<td width="260"><input class="easyui-textbox box" type="text"
							name="register_username" id="register_username"></td>
						<td class="star">*&nbsp;请确保长度为6~40</td>
					</tr>
					<tr>
						<td>密&nbsp;&nbsp;&nbsp;&nbsp;码:</td>
						<td><input class="easyui-textbox box" type="password"
							name="register_password" id="register_password"></td>
						<td class="star">*&nbsp;请确保长度为5~19</td>
					</tr>
					<tr>
						<td>密码确认:</td>
						<td><input class="easyui-textbox box" type="password"
							name="register_apassword" id="register_apassword"></td>
						<td class="star">*</td>
					</tr>
				</table>
			</div>
			...
			<div class="info_form2">
				<table border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td width="60">企业名称:</td>
						<td width="260"><input class="easyui-textbox box" type="text"
							name="register_company" id="register_company"></td>
						<td class="star">*</td>
					</tr>
					<tr>
						<td>法人代码:</td>
						<td><input class="easyui-textbox box" type="text"
							name="register_code" id="register_code"></td>
						<td class="star">*&nbsp;请填写9位代码</td>
					</tr>
					<tr>
						<td>注册时间:</td>
						<td><input class="easyui-datebox box" type="text"
							name="register_time" id="register_time" editable="false"
							panelHeight="260" panelWidth="200"></td>
						<td class="star">*&nbsp;工商局注册时间</td>
					</tr>
					<tr>
						<td>注册资金:</td>
						<td><input class="easyui-textbox box" type="text"
							name="register_money" id="register_money"></td>
						<td class="star">*</td>
					</tr>
					<tr>
						<td>单位性质:</td>
					...
					<tr>
						<td>联&nbsp;系&nbsp;人:</td>
						<td><input class="easyui-textbox box" type="text"
							name="register_contact" id="register_contact"></td>
						<td class="star">*</td>
					</tr>
					<tr>
						<td>电子邮箱:</td>
						<td><input class="easyui-textbox box" type="text"
							name="register_email" id="register_email"></td>
						<td class="star">*</td>
					</tr>
					<tr>
						<td>联系电话:</td>
						<td><input class="easyui-textbox box" type="text"
							name="register_phone" id="register_phone"></td>
						<td class="star">*</td>
					</tr>
					<tr>
						<td>邮政编码:</td>
						<td><input class="easyui-textbox box" type="text"
							name="register_address" id="register_address"></td>
						<td class="star">*</td>
					</tr>
					<tr>
						<td height="60">&nbsp;</td>
				...
				<table>
					<tr>
						<td width="30">&nbsp;</td>
						<td width="130"><div class="regbt" id="subform">
								<img name="register_signin" id="register_signin" alt="注册"
									src="<%=request.getContextPath()%>/image/register2.jpg"
									onclick="checkForm()"
									style="cursor: pointer; width: 110px; height: 40px;" />&nbsp;
							</div></td>
						<td width="300"><div class="clause">
								在接受本网站服务之前，请务必仔细<a href="#">阅读相关条款</a>并同意本声明。
							</div></td>
					</tr>
