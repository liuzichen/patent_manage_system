...
.container {
	...
	clear: both;
	position: relative;
	background: url(<%= request.getContextPath ()%>/image/login_bg.jpg);
}
...
.background {
	...
	margin-left: auto;
	margin-right: auto;
	background: url(<%= request.getContextPath ()%>/image/login_cbg.jpg);
	backgroud-repea: no-repeat;
}
	...
	<div id="login">
		...
		<div class="container">
			<div class="background">
				<div class="info">
					<form method="post"
						action="<%=request.getContextPath()%>/login/log" id="login_Form">
						<!-- action填目标文件地址 -->
						<table width="350" border="0" cellspacing="0" cellpadding="0">
							<input type="hidden" id="role" name="role" value="管理员用户">
							<tr>
								<td height="40" align="left">用户名</td>
								<td><input class="easyui-textbox" type="text"
									name="login_username" id="login_username" style="width: 180px;"></td>
							</tr>
							<tr>
								<td height="40" align="left">密&nbsp;&nbsp;&nbsp;&nbsp;码</td>
								<td><input class="easyui-textbox" type="password"
									name="login_password" id="login_password" style="width: 180px;"></td>
							</tr>
							<tr>
								<td height="40" align="left">验&nbsp;证&nbsp;码</td>
								<td align="left" height="40"><input class="easyui-textbox"
									type="text" name="login_code" id="login_code"
									style="width: 80px;">&nbsp;<img align=center alt="刷新"
									id="kaptchaImage"
									src="<%=request.getContextPath()%>/kaptcha.do"
									style="cursor: pointer;" onclick="changecode()" /> <a
									href="Javascript:void(0);" onclick="changecode()"
									style="font-size: 8pt;">看不清？</a></td>
							</tr>
							<tr>
								<td height="74">&nbsp;</td>
								<td><div style="float: left">
										<img name="login_signin" id="login_signin" alt="登录"
											src="<%=request.getContextPath()%>/image/signin.png"
											onclick="checkForm()" style="cursor: pointer;" />&nbsp;
									</div>
									<div
										style="float: left; line-height: 40px; padding-left: 20px;">
										<a href="<%=request.getContextPath()%>/maker/toRegisterMaker"
											style="color: #338cce;">新用户注册</a>
										<!-- 链接注册页面 -->
									</div></td>
