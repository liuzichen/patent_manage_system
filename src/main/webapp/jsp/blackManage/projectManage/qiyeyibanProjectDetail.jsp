...
<div >
	<div class="topnav"  >
	   <div  class="path" >
	      ...
	      <span ><font >创客项目管理&nbsp;&nbsp; &gt;&nbsp;&nbsp;企业一般项目查看</font></span>
	   </div>
     </div>
      <div class="context">
         <div class="titlebox"><span class="title">企业一般项目查看</span></div>
	     ...
	     <div >
	     	 ...
	     	 <table class="persional" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA">
	     	 	...
	     	 	<tr>
	     	 		...
	     	 		<td class="tdname" colspan="2" >
                   	 <div align="center" ><a href="#" class="easyui-linkbutton button" style="width:120px;height:25px">下载相关附件查看</a></div></td>
	     	 ...
	     	 <div title="专家评审结果" style="width:100%">
       			<div style="width:100%">
       			<% if(b==0){%>
       			<div class="tdcontent3" style="background-color:#F7F7F7;" align="center">
		               <div style="word-wrap:break-word;word-break:break-all;margin:0 auto;width:95%;">
	     					<pre style="width:100%;white-space:pre-wrap; font-size:14px">暂未完成专家评审，请等待评审结果！</pre>
		             </div>
		             </div>	
       			<%}  %>
       			<%if(b!=0){%>
