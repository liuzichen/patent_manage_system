...
<div >
	<div class="topnav"  >
	   <div  class="path" >
	      ...
	      <span ><font >创客项目管理&nbsp;&nbsp; &gt;&nbsp;&nbsp;创客项目详情查看</font></span>
	   </div>
     </div>
      ...
      <div class="context">
	     ...
	     <div >
	     	 <form action="<%=request.getContextPath()%>/maker/replyMakerCommonWork" name="Form1" id="Form1">
	     	 ...
	     	 <table class="persional" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA">
	     	 	...
	     	 	<tr>
	     	 		...
	     	 		<td class="tdname" colspan="2" >
                   	 <div align="center" ><a  id="download" class="easyui-linkbutton button" style="width:120px;height:25px">下载附件查看</a></div></td>
	     	  ...
	     	  <div title="专家评审结果" style="width:100%">
            	 ...
            	 <td  align="center"   colspan="3">
	            	 <div class="tdcontent3">
		               <div style="word-wrap:break-word;word-break:break-all;margin:0 auto;width:95%;">
	     					<pre style="width:100%;white-space:pre-wrap; font-size:16px">${item.comment}</pre>
		             </div>
		             </div>
		             </td> 
             </tr>
             <tr>             
	     	 ...
	     	 <div title="评价结果回复" style="width:100%">
            	 ...
            	 <td  align="center"   colspan="3">
	            	 <div class="tdcontent3">
		               <textarea id="evaluation" name="evaluation" cols="40" rows="12" style="width:90%;height:100%;" form="Form1"></textarea>
		             </div> 
		             </td>
             	</tr>
             	<tr>
