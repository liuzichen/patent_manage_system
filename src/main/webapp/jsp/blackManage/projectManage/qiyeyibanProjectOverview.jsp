    ...
    $('#roleList').datagrid({
		...
		{field: 'opt', title: '操作', width: 160, align: 'center',
            formatter: function (value,row,index) {
            	return "<a href='<%=request.getContextPath()%>/manageEnterprise/getEnterCommonWorkDetailAndComments?id="+ row.id +"'>项目详情查看</a>";  
            }
        }
  		]],
  		toolbar: [
...
$.ajax({
url:'<%=request.getContextPath()%>/manageEnterprise/getEnterCommonWorkListForAdminByState',
...
<form action="#" name="Form1" id="Form1">
	...
	<div class="context" style="width: 1085px">
		<div class="titlebox" style="width: 100%; margin: 0 auto;">
			<span class="title">企业一般项目一览表</span>
		</div>
