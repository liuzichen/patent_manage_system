            ...
            $('#roleList').datagrid({
				...
				{field : 'email',title : '电子邮箱',width : 160,align:'center',sortable:true},
				 { field: 'opt', title: '详情了解', width: 160, align: 'center',
          		...
          		toolbar: [
                	  {
                		text: '<input  type="text" style="width:150px;" id="state"  name="state" form="Form1" placeholder="请输入专家姓名查询">',
                	  },
                	  {
                		text: "搜索",
                  	  iconCls: "icon-search",
 ...
 <div>
     ...
     <div class="topnav"  >
	   <div  class="path" >
	      ...
	      <span ><font >用户信息管理&nbsp;&nbsp; &gt;&nbsp;&nbsp; 企业用户信息查看</font></span>
	   </div>
     </div> 
	<form action="#" name="Form1" id="Form1">
       	<input type="hidden" id="id" name="id">	 
    <div class="context" style="width:1085px">
     <div class="titlebox" style="width:100%; margin:0 auto;"><span class="title" >企业用户信息总览</span></div>
