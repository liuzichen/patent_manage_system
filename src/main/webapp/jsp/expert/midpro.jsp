...
<body>
 ...
 <div class="commonPage">
    ...
    <div class="context">
       <div class="titlebox"><span class="title">科技项目中期评审</span></div>
       <form method="post" action="<%=request.getContextPath()%>/expert/commentEnterProject?workId=${detail.id}&type=项目中期评审" name="Form1" id="Form1">
              ...
              <table class="persional" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA">
              	<tr>
	   			<td colspan="4" class="tdtitle" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;四、项目产出及成果情况</td>
                    ...
                    <td class="tdcontent1">
                      <%=request.getAttribute("name")%>万元
                    </td>
                    <td class="tdname">总产值：</td>
                    <td class="tdcontent2">
                       <%=request.getAttribute("age")%>万元
                    </td>
                </tr>
                <tr >
                ...
                <tr >
                    ...
                    <td class="tdcontent1">
                      <%=request.getAttribute("name")%>万美元
                    </td>
                    <td class="tdname">新增就业人数：</td>
                    <td class="tdcontent2">
                       <%=request.getAttribute("age")%>人
                    </td>
                </tr>
                <tr >
                    <td class="tdname">专利申请：</td>                    
                    <td class="tdcontent1" colspan="3">
                      <%=request.getAttribute("name")%>项
                    </td>                
                </tr>
                <tr >
                ...
                <tr >
                 ...
                 <tr >
                    ...
                    <td class="tdcontent1">
                      <%=request.getAttribute("name")%>篇
                    </td>
                    <td class="tdname">出版专著：</td>
                    <td class="tdcontent2">
                       <%=request.getAttribute("age")%>万字
                    </td>
                </tr>
                <tr >
