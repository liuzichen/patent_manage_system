...
<body>
	<div class="commonPage">
		...
		<div class="context">
			<div class="titlebox">
				<span class="title">一般项目立项评审</span>
			</div>
			<div>
				<form method="post"
					action="<%=request.getContextPath()%>/expert/updateEnterpriseCommonProject?id=1"
					name="Form1" id="Form1">
					...
					<table class="persional" align="center" border="1" cellpadding="0"
						...
						<tr>
							...
							<td class="tdcontent2">${detail.enterpriseId}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="tdcontent1">${detail.enterpriseId}</td>
