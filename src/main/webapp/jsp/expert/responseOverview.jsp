...
$(function () {
            $('#roleList').datagrid({     	
				...
				{field : 'title', title : '问题',width :336,align:'center'},
				{field : 'area', title : '领域',width :160,align:'center'},
				{field : 'askTime',title : '时间',width : 160,align:'center',sortable:true},
				 { field: 'opt', title: '详情了解', width: 160, align: 'center',
                    formatter: function (value,row,index) {
                    	return "<a href='<%=request.getContextPath()%>/expert/answer?questionId="+ row.id +"'>查看详情</a>";  
                    }
                }
