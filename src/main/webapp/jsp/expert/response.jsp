...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/response.css">
<link rel="stylesheet" type="text/css"
		...
		<div class="context">
			...
			<form method="post" action=<%=address %> id="reform" name="reform">
				<div class="box">
					...
					<div class="tablebox">
						<table
							style="border: solid #B8B8B8; border-width: 0px 1px 1px 1px; width: 100%">
							<tr>
								<td class="td"
									style="border: solid #B8B8B8; border-width: 0px 0px 1px 0px;">
									<div
										style="font-weight: bold; position: relative; left: 30px; width: 20%;">
										问题标题: ${questionDetail.title}</div>
									<div
										style="word-wrap: break-word; word-break: break-all; margin: 0 auto; width: 80%;">
							...
							<tr>
								<td class="td">
									<div
										...
										问题回复:</div>
									<div
										style="margin: 0 auto; position: relative; top: 15px; width: 80%; height: 300px">
										<textarea id="achievement" cols="40" rows="12"
											name="achievement" style="width: 100%; height: 90%;"></textarea>
									</div>
								</td>
							</tr>
							<tr>
								<td style="text-align: center; height: 45px"><a
									href="javascript:void(document.reform.submit())"
									class="easyui-linkbutton button" onclick="return checkform();">提&nbsp;&nbsp;交</a>
								</td>
							</tr>
