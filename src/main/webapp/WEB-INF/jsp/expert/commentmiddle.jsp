...
<body>
	...
	<div>
		...
		<div class="context">
			<div class="titlebox">
				<span class="title">项目中期检查报告</span>
			</div>
						...
						<div style="width: 100%">
							...
							<table class="persional" align="center" border="1"
								...
								<tr>
									...
									<td class="tdcontent1"><input
										class="easyui-datebox mydatebox" type="text" name="stime"
										id="stime" editable="false" panelHeight="260" panelWidth="200">
									</td>
									<td class="tdname">项目截止时间：</td>
									<td class="tdcontent1"><input
										class="easyui-datebox mydatebox" type="text" name="etime"
										id="etime" editable="false" panelHeight="260" panelWidth="200">
									</td>
								</tr>
								<tr>
