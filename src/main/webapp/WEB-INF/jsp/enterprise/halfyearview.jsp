...
<body>
	...
	<div>
		...
		<div class="context">
			<div class="titlebox">
				<span class="title">项目执行情况报表（半年）</span>
			</div>
						...
						<div style="width: 100%">
							<table class="persional" align="center" border="1"
								...
								<tr>
									...
									<td class="tdcontent1"><%=ii.getJ5()%></td>
									<td class="tdname">填报日期：</td>
									<td class="tdcontent2"><%=ii.getJ789()%></td>
								</tr>
								<tr>
									<td class="tdname">联系电话：</td>
									<td class="tdcontent2" colspan="3"><%=ii.getJ6()%></td>
								</tr>
							</table>
						</div>
					</div>
						...
						<div style="width: 100%">
							...
							<table class="persional" align="center" border="1"
								...
								<tr>
									...
									<td class="tdcontent2"><%=ii.getK5()%></td>
							...
							<table class="persional" align="center" border="1"
								...
								<tr>
									...
									<td class="tdcontent1"><%=ii.getK66()%>万元</td>
									<td class="tdname">总产值：</td>
									<td class="tdcontent2"><%=ii.getK67()%>万元</td>
								</tr>
								<tr>
									<td class="tdname">产品销售收入：</td>
									<td class="tdcontent1"><%=ii.getK68()%>万元</td>
									<td class="tdname">工业增加值：</td>
									<td class="tdcontent2"><%=ii.getK69()%>万元</td>
								</tr>
								<tr>
									<td class="tdname">净利润：</td>
									<td class="tdcontent1"><%=ii.getK70()%>万元</td>
									<td class="tdname">缴税总额：</td>
									<td class="tdcontent2"><%=ii.getK71()%>万元</td>
								</tr>
								<tr>
									<td class="tdname">创汇：</td>
									<td class="tdcontent1"><%=ii.getK72()%>万美元</td>
									<td class="tdname">新增就业人数：</td>
									<td class="tdcontent2"><%=ii.getK73()%>人</td>
								</tr>
								<tr>
									<td class="tdname">专利申请：</td>
									<td class="tdcontent1" colspan="3"><%=ii.getK74()%>项</td>
								</tr>
								<tr>
									<td class="tdname">其中发明专利：</td>
									<td class="tdcontent1"><%=ii.getK75()%>项</td>
									<td class="tdname">其中PCT专利：</td>
									<td class="tdcontent2"><%=ii.getK76()%>项</td>
								</tr>
								<tr>
									<td class="tdname">专利授权：</td>
									<td class="tdcontent1" colspan="3"><%=ii.getK77()%>项</td>
								</tr>
								<tr>
									<td class="tdname">其中发明专利：</td>
									<td class="tdcontent1"><%=ii.getK78()%>项</td>
									<td class="tdname">其中PCT专利：</td>
									<td class="tdcontent2"><%=ii.getK79()%>项</td>
								</tr>
								<tr>
									<td class="tdname">软件产品登记：</td>
									<td class="tdcontent1"><%=ii.getK80()%>项</td>
									<td class="tdname">软件著作权登记：</td>
									<td class="tdcontent2"><%=ii.getK81()%>项</td>
								</tr>
								<tr>
									<td class="tdname">发表科技论文：</td>
									<td class="tdcontent1"><%=ii.getK82()%>篇</td>
									<td class="tdname">出版专著：</td>
									<td class="tdcontent2"><%=ii.getK83()%>万字</td>
								</tr>
								<tr>
									<td class="tdname">形成新产品、新工艺等：</td>
									<td class="tdcontent1"><%=ii.getK84()%>项</td>
									<td class="tdname">其中国家重点新产品：</td>
									<td class="tdcontent2"><%=ii.getK85()%>项</td>
								</tr>
								<tr>
									<td class="tdname">科技奖励：</td>
									<td class="tdcontent1" colspan="3"><%=ii.getK86()%>项</td>
								</tr>
								<tr>
									<td class="tdname">其中国家级：</td>
									<td class="tdcontent1"><%=ii.getK87()%>项</td>
									<td class="tdname">其中省、市级：</td>
									<td class="tdcontent2"><%=ii.getK88()%>项</td>
								</tr>
								<tr>
									<td class="tdname">制定标准：</td>
									<td class="tdcontent1" colspan="3"><%=ii.getK89()%>项</td>
								</tr>
								<tr>
									<td class="tdname">其中国家：</td>
									<td class="tdcontent1"><%=ii.getK90()%>项</td>
									<td class="tdname">其中行业：</td>
									<td class="tdcontent2"><%=ii.getK91()%>项</td>
								</tr>
								<tr>
									<td class="tdname" colspan="2">建立示范基地、中试平台：</td>
									<td class="tdcontent1" colspan="2"><%=ii.getK92()%>个</td>
								</tr>
								<tr>
									<td class="tdname" colspan="2">建立实验室、工程技术研究中心：</td>
									<td class="tdcontent1" colspan="2"><%=ii.getK93()%>个</td>
								</tr>
								<tr>
									<td class="tdname" colspan="2">市级以上科技人才与创新团队：</td>
									<td class="tdcontent1" colspan="2"><%=ii.getK94()%>个</td>
								</tr>
								<tr>
