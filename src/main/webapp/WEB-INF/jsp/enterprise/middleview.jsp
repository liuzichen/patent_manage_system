						...
						<div style="width: 100%">
							...
							<table class="persional" align="center" border="1"
								...
								<tr>
									...
									<td class="tdcontent1"><%=ii.getK21()%>万元</td>
									<td class="tdname">总产值：</td>
									<td class="tdcontent2"><%=ii.getK22()%>万元</td>
								</tr>
								<tr>
									<td class="tdname">产品销售收入：</td>
									<td class="tdcontent1"><%=ii.getK23()%>万元</td>
									<td class="tdname">工业增加值：</td>
									<td class="tdcontent2"><%=ii.getK24()%>万元</td>
								</tr>
								<tr>
									<td class="tdname">净利润：</td>
									<td class="tdcontent1"><%=ii.getK25()%>万元</td>
									<td class="tdname">缴税总额：</td>
									<td class="tdcontent2"><%=ii.getK26()%>万元</td>
								</tr>
								<tr>
									<td class="tdname">创汇：</td>
									<td class="tdcontent1"><%=ii.getK27()%>万美元</td>
									<td class="tdname">新增就业人数：</td>
									<td class="tdcontent2"><%=ii.getK28()%>人</td>
								</tr>
								<tr>
									<td class="tdname">专利申请：</td>
									<td class="tdcontent1" colspan="3"><%=ii.getK29()%>项</td>
								</tr>
								<tr>
									<td class="tdname">其中发明专利：</td>
									<td class="tdcontent1"><%=ii.getK30()%>项</td>
									<td class="tdname">其中PCT专利：</td>
									<td class="tdcontent2"><%=ii.getK31()%>项</td>
								</tr>
								<tr>
									<td class="tdname">专利授权：</td>
									<td class="tdcontent1" colspan="3"><%=ii.getK32()%>项</td>
								</tr>
								<tr>
									<td class="tdname">其中发明专利：</td>
									<td class="tdcontent1"><%=ii.getK33()%>项</td>
									<td class="tdname">其中PCT专利：</td>
									<td class="tdcontent2"><%=ii.getK34()%>项</td>
								</tr>
								<tr>
									<td class="tdname">软件产品登记：</td>
									<td class="tdcontent1"><%=ii.getK35()%>项</td>
									<td class="tdname">软件著作权登记：</td>
									<td class="tdcontent2"><%=ii.getK36()%>项</td>
								</tr>
								<tr>
									<td class="tdname">发表科技论文：</td>
									<td class="tdcontent1"><%=ii.getK37()%>篇</td>
									<td class="tdname">出版专著：</td>
									<td class="tdcontent2"><%=ii.getK38()%>万字</td>
								</tr>
								<tr>
									<td class="tdname">形成新产品、新工艺等：</td>
									<td class="tdcontent1"><%=ii.getK39()%>项</td>
									<td class="tdname">其中国家重点新产品：</td>
									<td class="tdcontent2"><%=ii.getK40()%>项</td>
								</tr>
								<tr>
									<td class="tdname">科技奖励：</td>
									<td class="tdcontent1" colspan="3"><%=ii.getK41()%>项</td>
								</tr>
								<tr>
									<td class="tdname">其中国家级：</td>
									<td class="tdcontent1"><%=ii.getK42()%>项</td>
									<td class="tdname">其中省、市级：</td>
									<td class="tdcontent2"><%=ii.getK43()%>项</td>
								</tr>
								<tr>
									<td class="tdname">制定标准：</td>
									<td class="tdcontent1" colspan="3"><%=ii.getK44()%>项</td>
								</tr>
								<tr>
									<td class="tdname">其中国家：</td>
									<td class="tdcontent1"><%=ii.getK45()%>项</td>
									<td class="tdname">其中行业：</td>
									<td class="tdcontent2"><%=ii.getK46()%>项</td>
								</tr>
								<tr>
									<td class="tdname" colspan="2">建立示范基地、中试平台：</td>
									<td class="tdcontent1" colspan="2"><%=ii.getK47()%>个</td>
								</tr>
								<tr>
									<td class="tdname" colspan="2">建立实验室、工程技术研究中心：</td>
									<td class="tdcontent1" colspan="2"><%=ii.getK48()%>个</td>
								</tr>
								<tr>
									<td class="tdname" colspan="2">市级以上科技人才与创新团队：</td>
									<td class="tdcontent1" colspan="2"><%=ii.getK49()%>个</td>
								</tr>
								<tr>
