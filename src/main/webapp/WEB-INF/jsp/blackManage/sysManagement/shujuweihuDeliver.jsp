					...
					<table class="persional" align="center" border="1" cellpadding="0"
						...
						<tr>
							...
							<td class="tdcontent2"><input
								class="easyui-textbox mydatebox" style="width: 248px"
						...
						<tr>
							<td class="tdcontent2"><input
								class="easyui-textbox mydatebox" style="width: 248px"
								type="text" name="Content1" id="Content1"></td>
						</tr>
						<tr>
							<td class="tdcontent2"><input
								class="easyui-textbox mydatebox" style="width: 248px"
								type="text" name="Content2" id="Content2"></td>
						</tr>
						<tr>
							<td class="tdcontent2"><input
								class="easyui-textbox mydatebox" style="width: 248px"
								type="text" name="Content3" id="Content3"></td>
						</tr>
						<tr>
							<td class="tdcontent2"><input
								class="easyui-textbox mydatebox" style="width: 248px"
								type="text" name="Content4" id="Content4"></td>
						</tr>
						<tr>
							<td class="tdcontent2"><div
									style="margin-top: 5px; margin-left: auto; margin-right: auto; margin-bottom: 5px">
									<a href="javascript:void(document.Form1.submit())"
										style="height: 25px; width: 120px; font-size: 16px;"
										class="easyui-linkbutton button" onclick="return tianjia();">追加更多的内容</a>
								</div></td>
						</tr>
