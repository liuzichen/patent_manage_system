...
<body>
	...
	<div>
		...
		<div class="context">
			<div class="titlebox">
				<span class="title">修改系统管理员</span>
			</div>
			<div>
				<form action="" name="Form1" id="Form1">
					<table class="persional" border="0" cellpadding="0" cellspacing="0"
						bordercolor="#DEE5EA">
						<tr>
							<td class="tdname" style="background-color: white">用户登录ID：</td>
							<td class="tdcontent1" colspan="3"><input
								class="easyui-textbox box" type="text" name="AdministratorID"
								id="AdministratorID">
								<%request.getAttribute("AdministratorID");%></td>
						...
						<tr>
							...
							<td class="tdcontent1" colspan="3"><input
								class="easyui-textbox box" type="text" name="Name" id="Name"
								value='<jsp:attribute name="Name"></jsp:attribute>'></td>
							<td class="star">*&nbsp;请确保长度为6~40</td>
						</tr>
						...
						<tr>
							...
							<td class="tdcontent1" colspan="3"><input
								class="easyui-textbox box" type="text" name="Password"
								id="Password"
								value='<jsp:attribute name="Password"></jsp:attribute>'></td>
							<td class="star">*&nbsp;请确保长度为6~40</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="tdcontent2">
								<%request.getAttribute("RoleID");%> <select id="RoleID"
								name="RoleID" style="width: 245px; margin-left: 100px;"
								value='<jsp:attribute name="RoleID"></jsp:attribute>'>
					...
					<table class="persional"
						style="width: 100%; background-color: #F2F2F2" border="0"
							...
							<td align="center" style="width: 100%;">
								<div
									...
									<a href="javascript:void(document.Form1.submit())"
										style="height: 35px; width: 70px; font-size: 16px; align: center;"
										class="easyui-linkbutton button" onclick="return checkForm();">修改用户</a>
								</div>
							</td>
						</tr>
