...
<body>
	<div>
		...
		<div class="context">
			<div class="titlebox">
				<span class="title">系统公告查看</span>
			</div>
			<div>
				<form action="" name="Form1" id="Form1">
					<table style="width: 100%;" class="persional" align="center"
						border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA">
						<tr>
						...
						<tr>
							...
							<td class="tdcontent2"><%=request.getAttribute("Type")%></td>
						</tr>
						...
						<tr>
							...
							<td class="tdcontent2"><%=request.getAttribute("FujianType")%>
							</td>
							...
							<td class="tdname" colspan="4">
								<div align="left">
									<a href="#" class="easyui-linkbutton button" name="Fujian"
										style="width: 180px; height: 30px">相关附件下载查看</a>
								</div>
							</td>
