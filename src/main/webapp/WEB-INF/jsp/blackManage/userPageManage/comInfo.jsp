...
<body>
	<div>
		<div class="topnav">
			<div class="path">
				<span><font>当前位置:</font></span> <span><font>企业信息查看&nbsp;&nbsp;
						&gt;&nbsp;&nbsp;企业用户详情</font></span>
			</div>
		</div>
		<div class="context">
				...
				<form action="" name="Form1" id="Form1">
					<table class="persional" align="center" border="1" cellpadding="0"
						...
						<tr>
							...
							<td class="tdcontent1"><%=request.getAttribute("##1")%></td>
							<td class="tdname">法人代表：</td>
							<td class="tdcontent2"><%=request.getAttribute("#2")%></td>
						</tr>
						<tr>
							<td class="tdname">注册时间：</td>
							<td class="tdcontent1"><%=request.getAttribute("#5")%></td>
							<td class="tdname">注册资金：</td>
							<td class="tdcontent2"><%=request.getAttribute("#4")%></td>
						</tr>
						<tr>
							<td class="tdname">单位性质：</td>
							<td class="tdcontent1" colspan="3"><%=request.getAttribute("#5")%>
							</td>
						</tr>
						<tr>
							<td class="tdname">申报渠道：</td>
							<td class="tdcontent1" colspan="3"><%=request.getAttribute("channel1")%>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<%=request.getAttribute("channel2")%></td>
						</tr>
						<tr>
							...
							<td align="center" colspan="4">
								<div
									...
									<a href="javascript:void(document.Form1.submit())"
										...
										class="easyui-linkbutton button" onclick="sub();">返&nbsp;&nbsp;回</a>
								</div>
							</td>
						</tr>
					</table>
