		...
		<div class="topnav">
			<div class="path">
				<span><font>当前位置:</font></span> <span><font>用户信息管理&nbsp;&nbsp;
						&gt;&nbsp;&nbsp;专家用户信息查看与修改</font></span>
			</div>
		</div>
		<div class="context">
			<div class="titlebox">
				<span class="title">专家用户信息查看与修改</span>
			</div>
			<div>
					...
					<table class="persional" align="center" border="1" cellpadding="0"
						...
						<tr>
							...
							<td class="tdcontent1"><input
								class="easyui-textbox mydatebox" type="text" name="Name"
								id="Name"></td>
							<td class="tdname">年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;龄：</td>
							<td class="tdcontent2"><input
								class="easyui-textbox mydatebox" type="text" name="Age" id="Age"></td>
						</tr>
						<tr>
							<td class="tdname">工作单位：</td>
							<td class="tdcontent1"><input
								class="easyui-textbox mydatebox" type="text" name="Company"
								id="Company"></td>
						...
						<tr>
							...
							<td class="tdcontent1"><input
								class="easyui-textbox mydatebox" type="text" name="Major"
								id="Major"></td>
							<td class="tdname">联系电话：</td>
							<td class="tdcontent2"><input
								class="easyui-textbox mydatebox" type="text" name="Cellphone"
								id="Cellphone"></td>
						</tr>
						<tr>
							<td class="tdname">办公室电话：</td>
							<td class="tdcontent1"><input
								class="easyui-textbox mydatebox" type="text" name="Telephone"
								id="Telephone"></td>
					 ...
					 --%>
						...
						<tr>
							...
							<td class="tdcontent2" colspan="3"><input
								class="easyui-textbox mydatebox" type="text" name="Type"
								id="Type"></td>
						</tr>
						<tr>
							...
							<td align="center" height="400px" colspan="3">
								<div class="tdcontent3">
									<textarea id="Acievement" name="Achiement" cols="40" rows="12"
										style="margin-top: 10px; width: 90%; height: 90%;"></textarea>
								</div>
							</td>
						</tr>
