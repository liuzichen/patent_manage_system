...
<body>
	...
	<div class="title">
		<div class="title_left">
			<span style="position: absolute; bottom: 0px;">创客用户注册</span> <span
				style="position: absolute; bottom: 0px; font-size: 12px; left: 180px">适用于:个人、团队创业者及小微企业</span>
		</div>
		<div class="title_right">
			<a
				href="<%=request.getContextPath()%>/jsp/blackManage/test/register_company.jsp"
				style="position: absolute; bottom: 0px;">切换到企业用户注册</a>
			<!-- 提取企业注册相关信息后台代码 -->
		</div>
	</div>
	<div class="xline"></div>
			...
			<div class="info_form2">
				<table border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td width="60">团队名称:</td>
						<td width="260"><input class="easyui-textbox box" type="text"
							name="register_team" id="register_team"></td>
						<td class="star"></td>
					</tr>
					<tr>
						<td>负&nbsp;责&nbsp;人:</td>
