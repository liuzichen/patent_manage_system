					...
					<table class="persional" align="center" border="1" cellpadding="0"
						...
						<tr>
							...
							<td class="tdcontent2"><select id="field" name="field"
								class="mydatebox" onchange="getexpert()">
						...
						<tr>
							...
							<td class="tdcontent2"><select id="Expert1" name="Expert1"
								class="mydatebox">
						...
						<tr>
							...
							<td class="tdcontent2"><select id="Expert2" name="Expert2"
								class="mydatebox">
						...
						<tr>
							...
							<td class="tdcontent2"><select id="Expert3" name="Expert3"
								class="mydatebox">
						...
						<tr>
							...
							<td class="tdcontent2"><select id="Expert4" name="Expert4"
								class="mydatebox">
						...
						<tr>
							...
							<td class="tdcontent2"><select id="Expert5" name="Expert5"
								class="mydatebox">
						...
						<tr>
							...
							<td class="tdcontent2"><input type="radio" name="next"
								id="next" value="true">是
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<td align="center" colspan="2">
								<div
									...
									<a href="javascript:void(document.Form1.submit())"
										...
										class="easyui-linkbutton button" onclick="return sub();">确&nbsp;&nbsp;认</a>
								</div>
							</td>
						</tr>
					</table>
