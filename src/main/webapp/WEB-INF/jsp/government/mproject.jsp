...
<div >
	<div class="topnav"  >
	   <div  class="path" >
	      ...
	      <span ><font >信息与公告&nbsp;&nbsp; &gt;&nbsp;&nbsp; 创客创新项目</font></span>
	   </div>
     </div>
      <div class="context">
         <div class="titlebox"><span class="title">创客创新项目发布</span></div>
	     <div >
	     	 ...
	     	 <table class="persional" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#DEE5EA">
	     	 	...
	     	 	<tr>
	     	 		...
	     	 		<td class="tdcontent1"><input class="easyui-datebox mydatebox" type="text" name="startTime" id="startTime" editable="false" panelHeight="260" panelWidth="200"></td>
	     	 		<td class="tdname">活动结束时间：</td>
	     	 		<td class="tdcontent1"><input class="easyui-datebox mydatebox" type="text" name="endTime" id="endTime" editable="false" panelHeight="260" panelWidth="200"></td>
                ...
                <tr>
	             <td align="center" colspan="4">
	             	<div style="margin-top:15px;margin-left:auto;margin-right:auto; margin-bottom:15px" >
	             		<a href="javascript:void(document.Form1.submit())" style="height:35px;width:70px;font-size:16px;" class="easyui-linkbutton button" onclick="return sub();">发&nbsp;&nbsp;布</a>
	             	</div>
		        </td>
	        </tr>
	     	 </table>
