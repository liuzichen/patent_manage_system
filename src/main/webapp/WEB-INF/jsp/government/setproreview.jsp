							...
							<div style="width: 100%">
								...
								<table class="persional" align="center" border="1"
									...
									<tr>
										...
										<td class="tdcontent2"><%=request.getAttribute("B19")%>
										</td>
									...
									<tr>
										...
										<td class="tdcontent2"><%=request.getAttribute("B22")%>
										</td>
									...
									<tr>
										...
										<td class="tdcontent2"><%=request.getAttribute("B25")%>
										</td>
							...
							<div style="width: 100%">
								<table class="persional" align="center" border="1"
									...
									<tr>
										...
										<td class="tdcontent1"><select name="result" id="result"
											style="width: 50%">
												<option value="通过">通过</option>
												<option value="未通过">未通过</option>
										</select></td>
										<td class="tdname" align="center">上级评审部门</td>
										<td class="tdcontent1"><select name="next" id="next"
											style="width: 50%">
