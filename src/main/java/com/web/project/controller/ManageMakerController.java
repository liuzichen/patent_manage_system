...
import com.web.project.service.BackManage.ManageMakerService;
...
import com.web.project.vo.ManageMakerVo;
...
public class ManageMakerController {
	...
	@Autowired
	ManageMakerService makerInfoService;
	...
	public String getMakerInfoList(
		...
		ArrayList<ManageMakerVo> makerInfoVos = new ArrayList<ManageMakerVo>();
		for (int i = start; i < end; i++) {
			ManageMakerVo makerInfoVo = new ManageMakerVo();
